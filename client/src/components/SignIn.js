          ...
          <div className="flex flex-col items-center md:flex-row">
            <div className="w-full space-y-5 md:w-3/5 md:pr-16">
              <h2 className="text-2xl font-extrabold leading-none text-purple-600 hover:text-purple-500 sm:text-3xl md:text-5xl">
                Login now to Search the Properties 
              </h2>
            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              <div
                className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-gray-800  border-gray-800 rounded-lg shadow-2xl px-7"
                ...
                <div className="block">
                  {loading ? (
                    <button
                      disabled
                      type="button"
                      className=" text-black bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:ring-black font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 w-40 inline-flex items-center"
                    >
                      <svg
                        aria-hidden="true"
                        role="status"
                    ...
                    <button
                      className="w-full px-3 py-4 text-black font-bold bg-purple-600 hover:bg-purple-500 rounded-lg"
